...
public class MainFenetre implements IFenetre {

	private static MainFenetre instance = null;
	 ...
	 */
	public MainFenetre() {
		this.frmGestionDesEleves.setVisible(true);
		initialize();
	}
	 ...
	 * @return
	 */
	public static MainFenetre getInstance() {
		if (instance == null) {
	...
	public void initialize() {
		...
		btnajouter.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				GestionInfo gi = GestionInfo.getInstance();
				gi.launchProg(getFenetre());
