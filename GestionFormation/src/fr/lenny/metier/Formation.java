...
public class Formation {
	...
	public Formation(String nomFormation, String dateFormation,int nbSta, ArrayList<Stagiaire> lstStagiaires){
	...
	/**
	 * @param lstStagiaire the lstStagiaire to set
	 */
